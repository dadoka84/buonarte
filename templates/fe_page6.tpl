...
<head>
<meta http-equiv="content-type" content="text/html; charset=UTF-8"><script type="text/javascript" src="../tl_files/player/example/flowplayer-3.1.4.min.js"></script>
    ...
    <tr>
      <td><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
          <tr>
            ...
            <td width="617" align="left" valign="top"><?php echo $this->main; ?><br><div class="player">
		
						
			<a  
			 href="http://buonarte.com/tl_files/player/example/vid.flv"  
			 style="display:block;width:520px;height:347px"  
			 id="player"> 
		</a> 
	
		<!-- this will install flowplayer inside previous A- tag. -->
		<script>
			flowplayer("player", "../tl_files/player/flowplayer-3.1.5.swf");
clip: { 
