    ...
    <tr>
      <td><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
          <tr>
                      ...
                      <table width="90%" border="0" align="center" cellpadding="15" cellspacing="0">
                        <tr>
                          <td><span class="style5"> Kontaktirajte nas!</span><br />
                              ...
                              <span class="style3">Tel:  033/ 474-489<br />
                                Fax:  033/ 474-489</span><br /></td>
                        </tr>
                      </table>
                  </div></td>
                </tr>
            ...
            <td width="598" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td align="left" valign="top"><?php echo $this->main; ?>
                      <div align="center"><br>
                    </div></td>
                </tr>
                <tr>
                ...
                <tr>
                  <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="50%" align="left" valign="top"><?php echo $this->sections['a']; ?></td>
                        <td width="50%" align="left" valign="middle"><object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0" width="400" height="300">
                            <param name="movie" value="tl_files/music_academy/maps.swf">
                            <param name="quality" value="high">
                            <embed src="tl_files/music_academy/maps.swf" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="400" height="300"></embed>
                        </object></td>
                      </tr>
                  </table></td>
                </tr>
